...
content = content.replace("pub id: i32,", "pub id: u64,")
content = content.replace("type ValueType = i32;", "type ValueType = u64;")
...
replacements = [
    ("pub revision: i32,", "pub revision: u64,"),
    ("pub rev_created: i32,", "pub rev_created: u64,"),
    ("pub rev_deleted: Option<i32>,", "pub rev_deleted: Option<u64>,"),
    (
