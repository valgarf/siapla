...
export type GetHolidayQuery = { __typename?: 'Query', getFromOpenHolidays?: { __typename?: 'Holiday', dbId: number, name: string } | null };

export type ResourcesQueryVariables = Exact<{ [key: string]: never; }>;


export type ResourcesQuery = { __typename?: 'Query', resources: Array<{ __typename?: 'Resource', dbId: number, name: string, timezone: string, added: any, removed?: any | null, holiday?: { __typename?: 'Holiday', dbId: number, name: string } | null, availability: Array<{ __typename?: 'Availability', weekday: Weekday, duration: number }> }> };
