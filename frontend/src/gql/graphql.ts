...
export type ResourcesQuery = { __typename?: 'Query', resources: Array<{ __typename?: 'Resource', dbId: number, name: string, timezone: string, added: any, removed?: any | null, holiday?: { __typename?: 'Holiday', dbId: number } | null }> };
