...
export type ResourcesQuery = { __typename?: 'Query', resources: Array<{ __typename?: 'Resource', dbId: number, name: string, timezone: string, added: any, removed?: any | null, holiday?: { __typename?: 'Holiday', dbId: number, name: string, country?: { __typename?: 'Country', name: string, isocode: string } | null, region?: { __typename?: 'Region', name: string, isocode: string } | null } | null, availability: Array<{ __typename?: 'Availability', weekday: Weekday, duration: number }> }> };
